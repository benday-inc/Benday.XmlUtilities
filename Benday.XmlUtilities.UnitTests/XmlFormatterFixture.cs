...
public class XmlFormatterFixture
{
    ...
    public void FormatIgnoresNamespaces()
    {
        ...
        var expected = "<dgm:cxnLst>" + Environment.NewLine +
            "   <dgm:cxn " + Environment.NewLine +
            "       modelId=\"{984C432E-56F6-4FFD-AE06-1D5BC5C8986A}\"" + Environment.NewLine +
            "       srcId=\"{E6D4CB22-F4EF-4249-9CF0-9F99ACCA3C76}\"" + Environment.NewLine +
            "       destId=\"{483A9269-D346-44D3-BC91-7BE1710F0BD8}\"" + Environment.NewLine +
            "       srcOrd=\"0\"" + Environment.NewLine +
            "       destOrd=\"0\"" + Environment.NewLine +
            "       parTransId=\"{93DA09AE-1B35-48A0-A4C0-7E64C592EEB6}\"" + Environment.NewLine +
            "       sibTransId=\"{B051AA4E-3C0D-425D-9E5F-7098424FD377}\" />" + Environment.NewLine +
            "   <dgm:cxn " + Environment.NewLine +
            "       modelId=\"{13EB87B3-CF1F-4B4D-9F39-A239D315CF43}\"" + Environment.NewLine +
            "       type=\"presOf\"" + Environment.NewLine +
            "       srcId=\"{483A9269-D346-44D3-BC91-7BE1710F0BD8}\"" + Environment.NewLine +
            "       destId=\"{7E55710F-0F6B-4406-A2D6-704006B1480F}\"" + Environment.NewLine +
            "       srcOrd=\"0\"" + Environment.NewLine +
            "       destOrd=\"0\"" + Environment.NewLine +
            "       presId=\"urn:microsoft.com/office/officeart/2005/8/layout/hierarchy5\" />" + Environment.NewLine +
            "   <dgm:cxn " + Environment.NewLine +
            "       modelId=\"{9987CEC8-35BC-49E6-ABAB-02F35EC297A8}\"" + Environment.NewLine +
            "       type=\"presOf\"" + Environment.NewLine +
            "       srcId=\"{E6D4CB22-F4EF-4249-9CF0-9F99ACCA3C76}\"" + Environment.NewLine +
            "       destId=\"{1DDEF675-989C-45A0-97EC-C202056D8D1B}\"" + Environment.NewLine +
            "       srcOrd=\"0\"" + Environment.NewLine +
            "       destOrd=\"0\"" + Environment.NewLine +
            "       presId=\"urn:microsoft.com/office/officeart/2005/8/layout/hierarchy5\" />" + Environment.NewLine +
            "</dgm:cxnLst>";
